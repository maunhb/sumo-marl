'''
Make an x by x square grid .net.xml file. (UNFINISHED)
...
if __name__ == "__main__":
    ...
    ## write preamble
    f = open('{}x{}.net.xml'.format(gridSize, gridSize), 'w')
    ...
    for junction_id in junctions:
        for edge in inner_edges:
            f.write("<edge id='{}{}{}' from='{} 'to='{}' priority='3'>\n".format(junction_id, 
                                                                                 ...
                                                                                 from_junction, 
                                                                                 to_junction))
            f.write("lane id='{}{}{}_0' index='0' speed='13.89' length='129.20' shape='{}'/>".format(junction_id, 
                                                                                                     direction, 
                                                                                                     edgetype, 
                                                                                                     shape))

            f.write("lane id='{}{}{}_1' index='1' speed='13.89' length='129.20' shape='{}'/>".format(junction_id, 
                                                                                                     direction, 
                                                                                                     edgetype, 
                                                                                                     shape))
            f.write('</edge>\n')
        for edge in outer_edges:
            f.write("<edge id='{}{}{}' from='{} 'to='{}' priority='3'>\n".format(junction_id, 
                                                                                 ...
                                                                                 from_junction, 
                                                                                 to_junction))
            f.write("lane id='{}{}{}_0' index='0' speed='13.89' length='239.60' shape='{}'/>".format(junction_id, 
                                                                                                     direction, 
                                                                                                     edgetype, 
                                                                                                     shape))
            f.write("lane id='{}{}{}_1' index='1' speed='13.89' length='239.60' shape='{}'/>".format(junction_id, 
                                                                                                     direction, 
                                                                                                     edgetype, 
                                                                                                     shape))
            f.write('</edge>\n')

    ## write traffic light phases
    for junction_id in junctions: #traffic_lights:
