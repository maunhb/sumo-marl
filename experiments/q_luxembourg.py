...
if __name__ == '__main__':
    ...
    prs = argparse.ArgumentParser(formatter_class=argparse.ArgumentDefaultsHelpFormatter,
                                  description="""Q-Learning Luxembourg""")
    prs.add_argument("-route", dest="route", type=str, default='scenarios/luxembourg/DUERoutes/local.static.0.rou.xml', help="Route definition xml file.\n")
    ...
    out_csv = 'outputs/luxembourg/q_{}_alpha{}_gamma{}_eps{}_decay{}_reward{}'.format(experiment_time, args.alpha, args.gamma, args.epsilon, args.decay, args.reward)

    env = SumoEnvironment(net_file='scenarios/luxembourg/lust.net.xml',
