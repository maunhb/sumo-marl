...
if __name__ == '__main__':
    ...
    prs = argparse.ArgumentParser(formatter_class=
                                     ...
                                     description="Q-Learning 2x2-Intersection")
    prs.add_argument("-route", dest="route", type=str, default='scenarios/'\
                  'my2x2grid/2x2.rou.xml', help="Route definition xml file.\n")
    ...
    prs.add_argument("-summaryfile", dest="summaryfile", default='outputs/sum'\
        'maryq2x2.xml', type=str, required=False, help="Summary file(.xml).\n")
    args = prs.parse_args()
    experiment_time = str(datetime.now()).split('.')[0]
    out_csv = 'outputs/my-2x2-grid/q_{}_alpha{}_gamma{}_eps{}_decay{}_reward'\
