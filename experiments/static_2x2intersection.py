...
if __name__ == '__main__':
    ...
    prs = argparse.ArgumentParser(formatter_class=argparse.ArgumentDefaultsHelpFormatter,
                                  description="""Static 2x2 Intersection""")
    ...
    prs.add_argument("-summaryfile", dest="summaryfile", default='outputs/summarystatic2x2.xml', type=str, required=False, help="Choose a summary file name (.xml).\n")
    args = prs.parse_args()
